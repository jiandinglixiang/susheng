...
const people = !props.isLineCard && computed(() => formatNumber(props.itemData.reservation))
...
<template>
  <view :class="isLineCard ? 'live-line-card-item' : 'live-card-item'">
    ...
    <view class="bottom-box">
      <text v-if="!isLineCard" class="people">{{ people }}</text>
